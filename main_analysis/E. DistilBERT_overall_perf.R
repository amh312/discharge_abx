...
png("dischargeab_pr.png", width = 6, height = 6, units = "in", res = 300)
plot(
  prc$curve[, 1],
  prc$curve[, 2],
  type = "n",
...
time_df1[1, ] <- c("E. DistilBERT_overall_perf.R", time_taken)
